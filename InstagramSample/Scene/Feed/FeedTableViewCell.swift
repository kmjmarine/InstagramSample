...
final class FeedTableViewCell: UITableViewCell {
    ...
    private lazy var contentsLabel: UILabel = {
        ...
        label.text = "1_국내 카운터 요청 주소 https://api.corona-19.kr/korea/?serviceKey=tBfPTFEsqweS9OhluDoKmz6i7Nc5QjrkJ 2_시도별 발생동향 요청 주소 https://api.corona-19.kr/korea/country/new/?serviceKey=tBfPTFEsqweS9OhluDoKmz6i7Nc5QjrkJ"
    ...
    func setUp() {
        [postImageView, likeButton, commentButton, directMessageButton, bookmarkButton, currentLikedCountLabel, contentsLabel, dateLabel]
            .forEach {
                addSubview($0)
            }
